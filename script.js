...
const btnThemeGame = $('btn-theme');
const btnThemeLobby = $('btn-theme-lobby');
...
function updateThemeIcons(svgHtml) {
  if (btnThemeGame) btnThemeGame.querySelector('svg').innerHTML = svgHtml;
  if (btnThemeLobby) btnThemeLobby.querySelector('svg').innerHTML = svgHtml;
}

if (localStorage.getItem('picazo-theme') === 'dark') enableDarkMode();

function toggleTheme() {
  if (htmlEl.getAttribute('data-theme') === 'dark') disableDarkMode();
  else enableDarkMode();
}

if (btnThemeGame) btnThemeGame.addEventListener('click', toggleTheme);
if (btnThemeLobby) btnThemeLobby.addEventListener('click', toggleTheme);

function enableDarkMode() {
  htmlEl.setAttribute('data-theme', 'dark');
  localStorage.setItem('picazo-theme', 'dark');
  updateThemeIcons(iconSun);
}

function disableDarkMode() {
  htmlEl.removeAttribute('data-theme');
  localStorage.setItem('picazo-theme', 'light');
  updateThemeIcons(iconMoon);
}
